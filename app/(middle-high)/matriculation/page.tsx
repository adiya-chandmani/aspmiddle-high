                    ...
                    <div className="w-20 flex-shrink-0">
                      {r.logoUrl ? (
                        ...
                        <img
                          ...
                          className="h-16 w-16 rounded-md border border-navy-100 bg-white object-contain"
                        />
                      ) : (
                        <div className="h-16 w-16 rounded-md border border-navy-100 bg-navy-50" />
                      )}

                      {r.note && (
                        <div className="mt-2 rounded-md bg-navy-50 px-2 py-1.5">
                          <p className="whitespace-pre-line text-xs leading-relaxed text-gray-700">{r.note}</p>
                        </div>
                      )}
                    </div>
